...
@Component({
  selector: 'app-assign-bulk-permissions',
  templateUrl: './assign-bulk-permissions.component.html',
  styleUrls: ['./assign-bulk-permissions.component.css']
})
export class AssignBulkPermissionsComponent implements OnInit {
